<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EasternAuthentication.aspx.cs" Inherits="OnlineVirtualCookingSchool.EasternCuisine.EasternAuthentication" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            <h1 class="auto-style1">
                EASTERN CUISINE ENROLLMENT AUTHENTICATION
            </h1>
            <br /><br />
            ...
            <asp:Label ID="Label1" runat="server" Text="Student Email:"></asp:Label>&nbsp;&nbsp;&nbsp;<asp:TextBox ID="Txtemail" runat="server" required=""></asp:TextBox>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:OVCSConnectionString16 %>" SelectCommand="SELECT [lname] FROM [Levels]"></asp:SqlDataSource>
