...
{
    public partial class BPAuthentication : System.Web.UI.Page
    {
        bool flag = false;
        ...
        protected void ButEast_Click(object sender, EventArgs e)
        {
            ...
            string sqlquery = "select * from [dbo].[BakeryEnrollments] where StdEmail=@StdEmail and Blevel=@Blevel";
            sqlconn.Open();
            SqlCommand sqlcomm = new SqlCommand(sqlquery, sqlconn);
            sqlcomm.Parameters.AddWithValue("@StdEmail", Txtemail.Text);
            sqlcomm.Parameters.AddWithValue("@Blevel", DDList.SelectedItem.Text);
